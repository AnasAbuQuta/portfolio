window.SITE_DATA = {
  ...
  "dispatchLog": [
    {
      "tag": "[field]",
      "text": "beneficiary registered — Kobo Toolbox sync ok"
    },
    {
      "tag": "[code]",
      "text": "git commit -m \"fix: dashboard pagination\""
    },
    {
      "tag": "[field]",
      "text": "weekly coordination report exported (.xlsx)"
    },
    {
      "tag": "[code]",
      "text": "php artisan migrate — 0 errors"
    },
    {
      "tag": "[field]",
      "text": "case follow-up logged in Zite Manager"
    },
    {
      "tag": "[code]",
      "text": "npm run build — done in 4.2s"
    }
  ],
  "hero": {
    ...
    "groups": [
      {
        ...
        "items": [
          ...
          {
            "label": "HTML5 / CSS3 / Tailwind",
            "level": 88
          },
          {
            "label": "MySQL / REST APIs",
            "level": 78
          }
        ]
      },
    ...
    "items": [
      {
        ...
        "text": "Laravel & REST API development, database design, and full responsive web applications."
      },
      {
        "icon": "fa-solid fa-chart-line",
        "title": "Dashboards & Reporting",
        "text": "Data cleaning, Excel solutions, and dashboards that turn raw records into decisions."
      },
      {
        "icon": "fa-solid fa-database",
        "title": "Information Management",
        "text": "Data entry systems, structured record-keeping, and information workflows that scale."
      },
      {
        "icon": "fa-solid fa-people-group",
        "title": "Humanitarian Field Coordination",
        "text": "Digital forms, Kobo Toolbox deployments, and field data collection for NGO programs."
      }
    ]
  },
  "achievements": {
    ...
    "items": [
      {
        ...
        "issuer": "Issuing organization · Month Year",
        "link": "#"
      },
      {
        "title": "Certificate title placeholder",
  ...
  "testimonials": {
    ...
    "items": [
      {
        "quote": "Placeholder testimonial text goes here — swap in a real quote from a supervisor or teammate.",
  ...
  "contact": {
    ...
    "email": "anasabuquta825@gmail.com",
    "phone": "+970 56 787 0880",
    "linkedin": "https://www.linkedin.com/in/anas-abu-quta-4a25b1241/",
    "github": "https://linktr.ee/anasabuquta",
    "location": "Palestine",
    "cvUrl": "https://drive.google.com/file/d/1tY-sHGB5c1j_E1Vugu57es_cFmovwCTz/view?usp=sharing"
  },
  "footer": {
